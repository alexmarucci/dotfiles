...
_G.packer_plugins = {
  ...
  ["drex.nvim"] = {
    config = { "\27LJ\2\n \2\0\0\5\0\v\0\0156\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\2B\0\2\0016\0\b\0009\0\t\0'\2\n\0B\0\2\1K\0\1\0/autocmd FileType drex setlocal nobuflisted\bcmd\bvim\16keybindings\1\0\0\6n\1\0\0\1\0\4\6O9<cmd>lua require(\"drex\").open_parent_directory()<CR>\6o2<cmd>lua require(\"drex\").open_directory()<CR>\n<C-h>\1\n<C-l>\1\14configure\16drex.config\frequire\0" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-ts-rainbow", "nvim-ts-autotag" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp-buffer', 'cmp-spell', 'cmp-path', 'cmp-treesitter', 'cmp-rg'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspsaga.nvim', 'lua-dev.nvim', 'targets.vim', 'nvim-autopairs', 'nvim-lsp-installer', 'nvim-lspfuzzy', 'trouble.nvim', 'nvim-treesitter-refactor', 'dsf.vim', 'nvim-ts-rainbow', 'fzf', 'fzf.vim', 'nvim-web-devicons', 'gitsigns.nvim', 'Comment.nvim', 'nvim-bufferline.lua', 'nvim-colorizer.lua', 'nvim-ts-autotag', 'indent-blankline.nvim', 'vim-surround', 'renamer.nvim', 'cmp-nvim-lsp', 'lsp_extensions.nvim', 'lsp_signature.nvim', 'lspkind-nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
