...
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp_luasnip', 'cmp-rg', 'cmp-spell', 'LuaSnip', 'cmp-buffer', 'cmp-path', 'cmp-treesitter'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-rainbow', 'nvim-colorizer.lua', 'nvim-lspfuzzy', 'trouble.nvim', 'nvim-web-devicons', 'renamer.nvim', 'targets.vim', 'nvim-autopairs', 'gitsigns.nvim', 'todo-comments.nvim', 'Comment.nvim', 'nvim-lsp-installer', 'indent-blankline.nvim', 'lsp_extensions.nvim', 'nvim-ts-autotag', 'nvim-bufferline.lua', 'lsp_signature.nvim', 'lspkind-nvim', 'cmp-nvim-lsp', 'lspsaga.nvim', 'lua-dev.nvim', 'vim-surround', 'nvim-treesitter-refactor', 'nvim-neoclip.lua', 'fzf', 'fzf.vim', 'dsf.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
