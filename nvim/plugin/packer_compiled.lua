...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "cmp-nvim-lsp", "nvim-lspconfig", "cmp_luasnip", "cmp-treesitter", "cmp-tabnine", "cmp-spell", "nvim-autopairs", "cmp-path", "cmp-rg", "cmp-buffer" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
  ...
  ["lspsaga.nvim"] = {
    after = { "nvim-lspconfig" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
    config = { "\27LJ\2\n±\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\21symbol_in_winbar\1\0\0\1\0\a\17hide_keyword\2\14show_file\2\17folder_level\3\2\15color_mode\2\17respect_root\1\14separator\tï‘Š \venable\1\nsetup\flspsaga\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp_luasnip', 'cmp-treesitter', 'cmp-spell', 'cmp-path', 'cmp-rg', 'cmp-buffer'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp_extensions.nvim', 'lsp_signature.nvim', 'lspsaga.nvim', 'cmp-nvim-lsp', 'neodev.nvim', 'mason-lspconfig.nvim', 'mason.nvim', 'nvim-dap-ui', 'nvim-colorizer.lua', 'vim-bufsurf', 'typescript.nvim', 'trouble.nvim', 'nvim-lspconfig', 'nvim-surround', 'bufferline.nvim', 'nvim-ts-autotag', 'renamer.nvim', 'Comment.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-treesitter-refactor', 'dsf.vim', 'nvim-ts-rainbow', 'nvim-web-devicons', 'nvim-autopairs', 'nvim-treesitter-context', 'lspkind-nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
