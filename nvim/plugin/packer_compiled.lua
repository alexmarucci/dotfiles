...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "cmp-rg", "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-spell", "nvim-lspconfig", "cmp-treesitter", "cmp_luasnip", "cmp-tabnine", "nvim-autopairs" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
  ...
  ["lspsaga.nvim"] = {
    after = { "nvim-lspconfig" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
    config = { "\27LJ\2\n±\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\21symbol_in_winbar\1\0\0\1\0\a\17respect_root\1\14show_file\2\17hide_keyword\2\venable\1\15color_mode\2\17folder_level\3\2\14separator\tï‘Š \nsetup\flspsaga\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-autotag', 'bufferline.nvim', 'lsp_extensions.nvim', 'lsp_signature.nvim', 'cmp-nvim-lsp', 'nvim-treesitter-refactor', 'lspsaga.nvim', 'renamer.nvim', 'mason.nvim', 'gitsigns.nvim', 'nvim-surround', 'indent-blankline.nvim', 'nvim-dap-ui', 'nvim-web-devicons', 'typescript.nvim', 'lspkind-nvim', 'nvim-lspconfig', 'vim-bufsurf', 'dsf.vim', 'neodev.nvim', 'trouble.nvim', 'nvim-ts-rainbow', 'nvim-treesitter-context', 'nvim-autopairs', 'nvim-colorizer.lua', 'Comment.nvim', 'mason-lspconfig.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp-rg', 'cmp-buffer', 'cmp-path', 'cmp-spell', 'cmp-treesitter', 'cmp_luasnip'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
