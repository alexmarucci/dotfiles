...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "cmp-buffer", "cmp-path", "cmp-spell", "cmp-treesitter", "nvim-lspconfig", "cmp_luasnip", "nvim-autopairs", "cmp-tabnine", "cmp-nvim-lsp", "cmp-rg" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
  ...
  ["lspsaga.nvim"] = {
    after = { "nvim-lspconfig" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
    config = { "\27LJ\2\n±\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\21symbol_in_winbar\1\0\0\1\0\a\14separator\tï‘Š \venable\1\15color_mode\2\17respect_root\1\17folder_level\3\2\14show_file\2\17hide_keyword\2\nsetup\flspsaga\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-ts-context-commentstring", "nvim-treesitter-context", "nvim-ts-rainbow", "nvim-ts-autotag" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
  ...
  ["telescope.nvim"] = {
    after = { "nvim-neoclip.lua", "telescope-search-dir-picker.nvim", "telescope-fzf-native.nvim" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
...
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp-buffer', 'cmp-path', 'cmp-spell', 'cmp-treesitter', 'cmp_luasnip', 'cmp-rg'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter-refactor', 'indent-blankline.nvim', 'nvim-treesitter-context', 'nvim-ts-rainbow', 'nvim-ts-autotag', 'nvim-web-devicons', 'dsf.vim', 'vim-bufsurf', 'Comment.nvim', 'renamer.nvim', 'lspsaga.nvim', 'lsp_signature.nvim', 'mason-lspconfig.nvim', 'neodev.nvim', 'lsp_extensions.nvim', 'trouble.nvim', 'lspkind-nvim', 'nvim-surround', 'nvim-lspconfig', 'typescript.nvim', 'nvim-autopairs', 'cmp-nvim-lsp', 'nvim-dap-ui', 'bufferline.nvim', 'conflict-marker.vim', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
