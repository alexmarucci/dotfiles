...
_G.packer_plugins = {
  ...
  ["clever-f.vim"] = {
    loaded = true,
    path = "/Users/maru85945/.local/share/nvim/site/pack/packer/start/clever-f.vim",
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-context-commentstring", "nvim-treesitter-context", "nvim-treesitter-refactor", "nvim-ts-autotag", "vim-matchup", "nvim-ts-rainbow" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-web-devicons', 'nvim-lsp-installer', 'Comment.nvim', 'renamer.nvim', 'nvim-autopairs', 'nvim-treesitter-context', 'nvim-treesitter-refactor', 'indent-blankline.nvim', 'lspkind-nvim', 'gitsigns.nvim', 'fzf.vim', 'lua-dev.nvim', 'lsp_signature.nvim', 'lsp_extensions.nvim', 'cmp-nvim-lsp', 'nvim-surround', 'nvim-ts-autotag', 'dsf.vim', 'nvim-colorizer.lua', 'trouble.nvim', 'fzf', 'bufferline.nvim', 'nvim-lspfuzzy', 'nvim-ts-rainbow'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp-rg', 'cmp-treesitter', 'cmp-path', 'cmp-buffer', 'cmp-spell'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
