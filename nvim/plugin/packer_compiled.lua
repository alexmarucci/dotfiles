...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "nvim-autopairs", "nvim-lspconfig", "cmp-nvim-lsp" },
    loaded = true,
    only_config = true
  },
  ["cmp-buffer"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-autotag", "nvim-ts-context-commentstring", "nvim-treesitter-refactor" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp-buffer', 'cmp-path', 'cmp-rg', 'cmp-spell', 'cmp-treesitter'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspfuzzy', 'trouble.nvim', 'dsf.vim', 'nvim-ts-rainbow', 'fzf', 'fzf.vim', 'gitsigns.nvim', 'nvim-ts-autotag', 'indent-blankline.nvim', 'Comment.nvim', 'lsp_signature.nvim', 'lspkind-nvim', 'nvim-autopairs', 'lspsaga.nvim', 'renamer.nvim', 'nvim-lsp-installer', 'cmp-nvim-lsp', 'lua-dev.nvim', 'nvim-web-devicons', 'nvim-treesitter-refactor', 'nvim-bufferline.lua', 'nvim-colorizer.lua', 'lsp_extensions.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
