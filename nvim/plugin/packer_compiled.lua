...
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp-rg', 'cmp-spell', 'cmp_luasnip', 'LuaSnip', 'cmp-buffer', 'cmp-path', 'cmp-treesitter'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fzf', 'fzf.vim', 'gitsigns.nvim', 'nvim-ts-rainbow', 'indent-blankline.nvim', 'lsp_extensions.nvim', 'lspkind-nvim', 'renamer.nvim', 'lua-dev.nvim', 'nvim-ts-autotag', 'targets.vim', 'todo-comments.nvim', 'nvim-lsp-installer', 'nvim-bufferline.lua', 'Comment.nvim', 'nvim-autopairs', 'nvim-treesitter-refactor', 'cmp-nvim-lsp', 'vim-surround', 'nvim-lspfuzzy', 'lsp_signature.nvim', 'nvim-neoclip.lua', 'lspsaga.nvim', 'trouble.nvim', 'nvim-web-devicons', 'dsf.vim', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
