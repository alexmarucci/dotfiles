...
_G.packer_plugins = {
  ...
  cmp = {
    after = { "nvim-autopairs", "cmp-path", "nvim-lspconfig", "cmp-nvim-lsp", "cmp-treesitter", "cmp-buffer", "cmp_luasnip", "cmp-rg", "cmp-spell" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-context", "nvim-ts-autotag", "nvim-treesitter-refactor", "nvim-ts-context-commentstring", "nvim-ts-rainbow" },
    cond = { "\27LJ\2\n8\0\0\1\0\3\0\t6\0\0\0009\0\1\0009\0\2\0\n\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\vvscode\6g\bvim\0" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'dsf.vim', 'nvim-autopairs', 'nvim-lsp-installer', 'bufferline.nvim', 'nvim-treesitter-context', 'Comment.nvim', 'nvim-web-devicons', 'vim-bufsurf', 'nvim-ts-autotag', 'lspsaga.nvim', 'lsp_signature.nvim', 'neodev.nvim', 'lsp_extensions.nvim', 'cmp-nvim-lsp', 'nvim-dap-ui', 'nvim-colorizer.lua', 'renamer.nvim', 'nvim-treesitter-refactor', 'lspkind-nvim', 'trouble.nvim', 'nvim-ts-rainbow', 'indent-blankline.nvim', 'nvim-surround', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'cmp-path', 'cmp-treesitter', 'cmp-buffer', 'cmp_luasnip', 'cmp-rg', 'cmp-spell'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
